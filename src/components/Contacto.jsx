    ...
    <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
            <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                <h1 className="xl:text-4xl text-3xl pb-4 text-white font-bold">Contactanos</h1>
                <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">¿Tienes alguna pregunta? ¿Estas interesado en colaborar con nosotros?. Solo contactanos te respoderemos lo antes posible.</p>
                ...
                <p className="text-lg text-white pt-10 tracking-wide">
                    Saturno 904 <br />
                    Los Ángeles, León GTO
                </p>
                <a href="javascript:void(0)">
                    <p className="text-white pt-16 font-bold tracking-wide underline">Ver vacantes</p>
                </a>
            </div>
        </div>
        <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                <h1 className="text-4xl text-gray-800 font-extrabold mb-6">Tus datos</h1>
